...
class Item(db.Model):
    ...
    def serialize(self):
        return {
            'itemId': int(self.itemId) if self.itemId is not None else None,
...
class Auction(db.Model):
    ...
    def serialize(self):
        return {
            'auctionId': int(self.auctionId) if self.auctionId is not None else None,
            ...
            'buyerPhone': self.buyer.phoneNum if self.buyer else None,
